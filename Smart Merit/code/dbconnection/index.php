...
$id = $_POST['id'];
$pass = $_POST['pass'];
$sql="select id,name from colleges where id='".$_POST['id']."' and pass='".$_POST['pass']."'";
$conn = connect();
$res = $conn -> query($sql);
if ($res) {
	if ($res -> num_rows != 1) {
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      <a class="navbar-brand" href="../index.html">DigIndia</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
           ...
           <li class="nav-item">
            <a class="nav-link" href="#">MYGOV</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">ABOUT</a>
          </li>
        <li class="nav-item">
            <a class="nav-link" href="#">UPDATE REQUEST</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="index.html"><i class="fa fa-user" aria-hidden="true"></i>
 Login</a>
              <a class="dropdown-item" href="../register/index.php"><i class="fa fa-user-plus" aria-hidden="true"></i>
 Register</a>
            </div>
          </li>
            <li class="nav-item">
    ...
    <section class="jumbotron">
        <div id="form" class="container-fluid gradient">
            <div class="container">
			<form id="needs-validation" action="<?php echo $_SERVER['PHP_SELF'] ?>" method = 'post' novalidate>
				<?php
				if (isset($_SESSION['err']))
				    echo "<p style='color:red';>log in first</p>";
				?>
            ...
            <br>
            <p>Your School is not registered yet? <a href="../register/index.php">Register here!</a></p>
            </div>
			<script>
